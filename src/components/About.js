  ...
  render() {
    return (
      <div id='about_content'>
        ...
        <h2 id='subtitle'>
          a <a className='software' href='software.html'>software engineer</a>
          and <a className='visual' href='visual.html'>designer</a> from the Bay Area.
        </h2>
        <p>
        ...
        <a id='recent_code_link' target="_blank"><pre><code id='recent_code' className='hljs diff'></code></pre></a>
      </div>
    );
  }
});
